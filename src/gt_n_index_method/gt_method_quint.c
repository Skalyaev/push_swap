...
void gap_finded_gt(t_data *data)
{
        ...
        if (data->b != data->j)
        {
                if (get_to_raw(&data->b, data->b_start, data, data->j->nb) && data->to_raw > 0)
                        ++data->b_r_rot_needed;
                else
                        ++data->b_rot_needed;
        }
...
void closest_top_head_bis(t_data *data)
{
        ...
        while (data->j != data->temp && data->j->index < data->index->index && (data->index->index < data->i->index && data->index->index > data->prev->index - 1 + data->offset))
        {
                data->j = data->j->prev;
                data->index = data->j->prev;
                if (!data->index)
...
{
        data->j = data->b;
        while (data->j->index > data->i->index || data->j->index < data->prev->index - 1 + data->offset)
        {
                data->j = data->j->prev;
                if (!data->j)
                        data->j = data->b_end;
        ...
        if (!data->index)
                data->index = data->b_end;
        if (data->j->index > data->index->index || (data->index->index > data->i->index || data->index->index < data->prev->index - 1 + data->offset))
        {
